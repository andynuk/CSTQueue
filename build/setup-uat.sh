...
echo "Authenticating..."
sfdx force:auth:jwt:grant --instanceurl https://test.salesforce.com --clientid $SFDC_PROD_CLIENTID --jwtkeyfile uatkeys/server.key --username $SFDC_UAT_USER  -a UAT 
